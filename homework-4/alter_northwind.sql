...
DELETE FROM products WHERE products.discontinued = 1
DELETE FROM order_details WHERE exists (select * from products where products.product_id <> order_details.product_id)
